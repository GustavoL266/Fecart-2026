...
const COMPLETE_CLARIFICATION_INSTRUCTIONS = `No modo complete, uma pendência AI_REQUIRED_FIELD_MISSING autoriza estimar esse campo seguindo as regras de estimativa, exceto expectedMonthlyUnits, que exige mês/mensal explícito. Para as outras pendências, use a resposta atual para resolver somente o que ela realmente esclarece. Os campos completos e estimados da análise anterior serão preservados pelo backend.`;
