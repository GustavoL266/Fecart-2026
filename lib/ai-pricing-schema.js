...
export const AI_FIELD_RULES = Object.freeze({
  ...
  materialCost: { schema: money, label: "Matéria-prima por unidade", kind: "money", hint: /mat[eé]ria|insumos?|ingredientes?|custo|gast(?:o|ei)/i, batch: true },
...
export const AI_OUTPUT_JSON_SCHEMA = {
  type: "object", additionalProperties: false, required: ["entries"], properties: {
    ...
    // as too complex. The strict Zod schema below still enforces the same limit.
