import { z } from "zod";
import { normalizeFiscalState, isValidFiscalState } from "../js/domain/fiscal-context.js";
...
const brazilState = z.string().transform(normalizeFiscalState).refine(isValidFiscalState, "Informe uma UF brasileira válida.");
