...
export const EMPTY_OPTIONAL_FIELD_IDS = Object.freeze([
  "companyFreightShare", "otherVariableCost", "otherDirectExpenses", "monthlyLaborCost",
  "monthlyProductiveHours", "laborHourlyCost", "allocationLaborHours", "machineTimeMinutes",
  ...
  "marketplaceFeeRate", "fixedFeePerOrder", "postSaleLossRate", "minimumMargin",
  "monthlyCapitalRate", "discountRate", "fixedDiscountAmount", "marketPrice",
]);
